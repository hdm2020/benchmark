...
nohup Rscript --vanilla tRap.predict.R -f $datadir/testsnp -m $datadir/testdata_intertRap.jaspar587tf.csv --pwmdb jaspar -o $datadir/pwm_jaspar20221/results/tRap.jaspar2022.txt &
...
nohup Rscript --vanilla tRap.predict.R -f $datadir/testsnp -m $datadir/testdata_intertRap.hocomoco401tf.csv --pwmdb hocomoco -o $datadir/pwm_hocomocov11/results/tRap.hocomocov11.txt
...
mv besttfmodel.roc.prc.txt tRap.jaspar2022.besttfmodel.roc.prc.txt
...
Rscript --vanilla bestmotif.R --f1 $datadir/tRap.jaspar2022.tf.roc.prc.txt --f2 $datadir/tRap.hocomocov11.tf.roc.prc.txt --f3 $datadir/tRap.jaspar2022.merged.expe.pred.results.txt --f4 $datadir/tRap.hocomocov11.merged.expe.pred.results.txt --o1 $datadir/tRap.alltf.bestmodel.roc.prc.txt --o2 $datadir/tRap.alltf.merged.expe.pred.results.txt
