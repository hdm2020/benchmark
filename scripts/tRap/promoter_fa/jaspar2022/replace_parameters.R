...
library(tRap)
motif<- read.jaspar("./JASPAR2022_CORE_vertebrates_non-redundant_pfms_jaspar.txt")
...
#save
hocomoco<-motif
save(hocomoco,file="./tRap_jaspar2022/data/jaspar.RData")
save(gevparams, file="./tRap_jaspar2022/data/gevparams.RData")
save(exactgevparams, file="./tRap_jaspar2022/data/exactgevparams.RData")
save(list=c("gevparams", "exactgevparams"), file="./tRap_jaspar2022/R/sysdata.rda")
