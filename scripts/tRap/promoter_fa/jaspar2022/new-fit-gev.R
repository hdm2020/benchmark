...
####modify from ../../tRap/inst/scripts/fit-gev.R
...
#####motif PFM matrix####
#data(jaspar)#use new jaspar_2022 data to replace it
jaspar22 <- read.jaspar("./JASPAR2022_CORE_vertebrates_non-redundant_pfms_jaspar.txt")
print(length(jaspar22))
print('read jaspar_2022 finished')
...
promoter.path = getwd()
promoter.path = gsub('/jaspar2022','',promoter.path)
