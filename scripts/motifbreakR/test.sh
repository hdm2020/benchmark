...
nohup Rscript --vanilla motifbrekR.predict.R -f $datadir/testsnppos.bed -m $datadir/testdata_intermotifbrekR.jaspar587tf.csv --pwmdb jaspar -g BSgenome.Hsapiens.UCSC.hg19 --method default -o $datadir/pwm_jaspar20221/results/motifbrekR.jaspar2022.txt &
...
nohup Rscript --vanilla motifbrekR.predict.R -f $datadir/testsnppos.bed -m $datadir/testdata_intermotifbrekR.hocomoco400tf.csv --pwmdb hocomoco -g BSgenome.Hsapiens.UCSC.hg19 --method default -o $datadir/pwm_hocomocov11/results/motifbrekR.hocomocov11.txt
...
#6.2 HOCOMOCO v11
Rscript --vanilla auroc_auprc.R -e ../snpdata/testdata/evaldata -f $datadir/motifbreakR.hocomocov11.merged.expe.pred.results.txt -m $datadir/evaldata_intermotifbreakR.hocomoco401tf.csv -d alleleDiff -o $datadir/motifbreakR.hocomocov11.tf.roc.prc.txt
